...
return DataSourceBuilder.create().build();
    ...
    //application is deleaing with db which is inturn
//    dealing with DB
    //em is required by jpa
    // previously spring is taking care of evry thing
    // but now we have to take care of every thing
}
